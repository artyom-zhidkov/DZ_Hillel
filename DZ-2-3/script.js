...
function task2() {
    ...
    //можно ещё сделать проверку на случай, если start>end 
...
// написанный цикл выше не будет работать для двухзначных чисел.
// на случай если текст будет содержать числа, состоящие более чем из одной цифры я написал следующий цикл. 
// его ещё можно доработать для дробных чисел)
//    for (let i = 0; i < myText.length; i++) {
//        if (Number(myText[i])) {
